...
describe('Header - Délai des sous-menus', () => {
  ...
  test('Le logo et la tagline sont présents', () => {
    ...
    const taglineContainer = screen.getByText('E').closest('div')?.parentElement?.parentElement;
    expect(taglineContainer).toHaveTextContent('Solutions de Téléphonie IP');
    expect(taglineContainer).toHaveTextContent('et communications d\'entreprise');
  });
});
