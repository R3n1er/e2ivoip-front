...
export default function AssistantsVocauxIA() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Vos clients sont accueillis et orientés à toute heure, même en dehors des horaires d'ouverture",
    },
    {
      icon: "lni-users",
      title: "Personnalisation avancée",
      description:
        "Adaptez le comportement et les réponses selon votre secteur d'activité",
    },
    {
      icon: "lni-bolt",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
                ...
                l&apos;intelligence artificielle. Offrez une expérience client
                ...
                <Card key={index} className="text-center border-gray-200">
                  <CardHeader>
                    <div className="bg-red-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                      <i
                        className={`lni ${feature.icon} w-8 h-8 text-red-600`}
                      ></i>
                    </div>
              ...
              {[
                {
                  ...
                  description:
                    "L'assistant accueille vos appelants et les oriente vers le bon service",
                  example:
