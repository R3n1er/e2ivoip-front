...
> 📌 **Mémoire projet** : consulter `memory.md` à la racine pour le suivi global (décisions, contexte, intégrations, historique). À mettre à jour à chaque décision structurante.
