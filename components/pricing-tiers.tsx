  ...
  return (
    <section className="bg-white py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid border-y border-ui-border md:grid-cols-2 xl:grid-cols-5">
          {tiers.map((tier) => (
            <article
              key={tier.calls}
              className="border-b border-ui-border py-8 md:px-6 md:[&:nth-child(odd)]:border-r xl:border-b-0 xl:border-r xl:last:border-r-0 xl:[&:nth-child(odd)]:border-r"
            >
              ...
              <p className="mt-3 min-h-10 text-sm leading-relaxed text-ui-muted">
                {tier.description}
              </p>
              <ul className="mt-6 space-y-3 border-t border-ui-border pt-5 text-sm text-gray-dark">
