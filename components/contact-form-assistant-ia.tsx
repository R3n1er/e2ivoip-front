      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-dark mb-6">
            Discutons de votre projet d&rsquo;
            <span className="text-red-primary">assistant vocal IA</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Prenez 10 minutes pour échanger avec nous. Ensemble, identifions
            comment cet assistant pourrait vous faire gagner au moins 5 heures
            par semaine.
          </p>
        </div>
