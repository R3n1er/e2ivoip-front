...
| 7 | `/telephonie-entreprise/3cx-smb-mutualisee` | ✅ | Prix 15€ retiré → sur devis (×3). Délai 24h → rapide. Support local → mail+tél. H1 + title SEO → « 3CX SMB PRO Mutualisé ». Capacité 3 à 10 utilisateurs. Title dédupliqué. Commit `f70eb64`. |
