...
export const mockBlogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Découvrez comment la téléphonie IP peut transformer vos communications d'entreprise avec des économies substantielles et des fonctionnalités avancées.",
    content:
      "<p>La téléphonie IP révolutionne les communications d'entreprise...</p>",
    ...
    metaDescription:
      "Guide complet pour comprendre et implémenter la téléphonie IP en entreprise",
  ...
  },
  {
    ...
    excerpt:
      "Analyse comparative entre 3CX et les solutions de téléphonie traditionnelles pour vous aider à faire le bon choix.",
    content:
      "<p>3CX offre de nombreux avantages par rapport aux solutions traditionnelles...</p>",
    ...
    metaDescription:
      "Comparatif détaillé entre 3CX et les solutions de téléphonie traditionnelles",
  ...
  },
  {
    ...
    excerpt:
      "Conseils pratiques pour améliorer la qualité audio de vos communications VoIP et éviter les problèmes courants.",
    content:
      "<p>La qualité audio est cruciale pour des communications professionnelles efficaces...</p>",
    ...
    metaDescription:
      "Guide pour optimiser la qualité audio de vos communications VoIP",
  ...
  },
  {
    ...
    excerpt:
      "Les mesures de sécurité essentielles pour protéger votre infrastructure de téléphonie IP contre les menaces.",
    content:
      "<p>La sécurité en téléphonie IP nécessite une approche multicouche...</p>",
    ...
    metaDescription:
      "Bonnes pratiques de sécurité pour votre infrastructure de téléphonie IP",
  ...
  },
  {
    ...
    excerpt:
      "Planifiez votre migration vers la téléphonie IP avec notre guide étape par étape pour une transition réussie.",
    content:
      "<p>La migration vers la téléphonie IP nécessite une planification minutieuse...</p>",
    ...
    metaDescription:
      "Guide de migration vers la téléphonie IP avec les étapes clés",
  ...
  },
  {
    ...
    excerpt:
      "Découvrez les avantages des Trunk SIP et comment les implémenter efficacement dans votre infrastructure.",
    content:
      "<p>Les Trunk SIP offrent une flexibilité et des économies importantes...</p>",
